...
class TestKlotski99Dev(unittest.TestCase):
    ...
    def common_method(self, numbers):
        ...
        steps = klotski99_dev.get_path_warp(numbers)
        end_time = time.time()
    ...
    def test13(self):
        ...
        # [0, 2, 3, 5, 12, 6, 15, 7, 8, 1, 11, 28, 4, 13, 24, 26, 25, 17, 18, 27, 99, 22, 20, 40, 14, 16, 35, 36, 46, 37, 10, 19, 30, 32, 23, 34, 54, 63, 55, 38, 31, 33, 42, 43, 44, 9, 45, 21, 29, 39, 59, 52, 41, 53, 47, 64, 56, 57, 48, 49, 69, 50, 70, 72, 66, 74, 67, 58, 68, 79, 61, 51, 73, 65, 75, 76, 77, 78, 60, 71, 62]
        self.common_method(numbers)